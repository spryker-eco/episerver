...
interface EpiserverConstants
{
    ...
    public const ORDER_NEW_MAILING_ID = 'EPISERVER:ORDER_NEW_MAILING_ID';
    public const ORDER_SHIPPING_CONFIRMATION_MAILING_ID = 'EPISERVER:ORDER_SHIPPING_CONFIRMATION_MAILING_ID';
    public const ORDER_CANCELLED_MAILING_ID = 'EPISERVER:ORDER_CANCELLED_MAILING_ID';
    public const ORDER_PAYMENT_IS_NOT_RECEIVED_MAILING_ID = 'EPISERVER:ORDER_PAYMENT_IS_NOT_RECEIVED_MAILING_ID';
